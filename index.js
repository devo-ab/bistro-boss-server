...
async function run() {
  try {
    ...
    app.get("/admin-stats", verifyToken, verifyAdmin, async(req, res) => {
      ...
      const revenue = await result.length > 0 ? result[0].totalRevenue : 0;
     ...
     * 3. for every item in the menuCollection that you found from a payment entry (document)
     */

    // using arrrigate pipeline
...
// root api
app.get('/', (req, res) =>{
    res.send("Bistro Boss Is Running Successfully")
});
// root api
